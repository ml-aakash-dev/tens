...
const BannerNavArrImg = () => {
    return (
        <div className="nav-arr-img pointerEventNone">
                    
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 330 330" style={{enableBackground: 'new 0 0 330 330', transform: 'rotate(-45deg)'}} xmlSpace="preserve">
...
export default BannerNavArrImg
